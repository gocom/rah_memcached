...
"Download":https://github.com/gocom/rah_memcached/releases | "Packagist":https://packagist.org/packages/rah/rah_memcached | "Twitter":http://twitter.com/gocom | "Issues":https://github.com/gocom/rah_memcached/issues | "Donate":http://rahforum.biz/donate/rah_memcached
...
Or "download":https://github.com/gocom/rah_memcached/releases a plugin package.
...
"Homebrew":http://brew.sh package manager and the "Homebrew-PHP repository":https://github.com/josegonzalez/homebrew-php are one of the easiest ways to manage PHP installations on Mac OS. After you have "tapped to the Homebrew-PHP repository":https://github.com/josegonzalez/homebrew-php#installation, you can simply install @php@ and @memcached@ with:

bc. $ brew install php55 php55-memcached

This will install PHP 5.5, Memcached extension and its dependencies.
