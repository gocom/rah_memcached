...
*name*
Sets a name, a key, for the cached item. The given name used identify the item and fetch it from the storage. If a _name_ is not defined, its automatically created by hashing the given contained markup. While the name is option, giving it is more efficient and avoids any potential collisions.
